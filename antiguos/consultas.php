...
<form method="POST" action="consultas.php" onSubmit="return Validator(this);">
  <div align="center">
...
*/
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td> <font face="Trebuchet MS"> 
		<input name="nombre" size="35" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="1"></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td> <font face="Trebuchet MS" style="font-size: 9pt">
			E-mail:</font></td>
      <td> <font face="Trebuchet MS"> 
		<input name="email" size="35" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="2"></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td> <font face="Trebuchet MS" style="font-size: 9pt">
			Teléfono:</font></td>
      <td> <font face="Trebuchet MS"> 
		<input name="telefono" size="35" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="3"></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td> <font face="Trebuchet MS" style="font-size: 9pt">
			Fecha de llegada:</font></td>
      <td> <font face="Trebuchet MS"> 
		<input name="llegada" size="35" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="4"></font></td>
    </tr>
        <tr bgcolor="#FFFFFF">
      <td> <font face="Trebuchet MS" style="font-size: 9pt">
			Fecha de salida:</font></td>
      <td> <font face="Trebuchet MS"> 
		<input name="salida" size="35" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="5"></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td valign="top"> <font face="Trebuchet MS" style="font-size: 9pt">
			Consulta:</font></td>
      <td> <font face="Trebuchet MS"> 
		<textarea name="consulta" cols="35" rows="4" style="color: #85B000; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #85B000" tabindex="6"></textarea></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td> 
		<p align="left"><font face="Trebuchet MS"> 
		<input type="submit" name="Submit" value="Enviar" style="color: #FFFFFF; font-family: Trebuchet MS; font-size: 9pt; font-weight: bold; border: 1px solid #000000; background-color: #85B000"></font></td>
      <td> <font face="Trebuchet MS" style="font-size: 9pt">&nbsp;</font></td>
    </tr>
    </table>
	</div>
	</div>
